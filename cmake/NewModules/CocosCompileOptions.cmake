macro(target_apply_cocos_options target_name)
 ...
 if(MSVC)
     ...
     target_compile_options(${target_name} PUBLIC -DUNICODE -D_UNICODE)
     target_compile_options(${target_name} PUBLIC -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
     ...
     if(CMAKE_BUILD_TYPE STREQUAL "Debug")
         target_compile_options(${target_name} PUBLIC -DCOCOS2D_DEBUG=1)
     endif()
 ...
 if(WINDOWS)
     ...
     if(BUILD_SHARED_LIBS)
         target_compile_options(${target_name} PUBLIC -D_USRDLL -D_EXPORT_DLL_ -D_USEGUIDLL -D_USREXDLL -D_USRSTUDIODLL)
     else()
         target_compile_options(${target_name} PUBLIC -DCC_STATIC)
     endif()

     target_compile_options(${target_name} PUBLIC -DCOCOS2DXWIN32_EXPORTS -D_WINDOWS -DWIN32 -D_WIN32)
     set(PLATFORM_FOLDER win32)
 elseif(APPLE)
     target_compile_options(${target_name} PUBLIC -DUSE_FILE32API)
     if(MACOSX)
         target_compile_options(${target_name} PUBLIC -DTARGET_OS_MAC)
         set(PLATFORM_FOLDER mac)
     elseif(IOS)
         # TARGET_OS_IOS
         # target_compile_options(${target_name} PUBLIC -DTARGET_OS_IPHONE)
         target_compile_options(${target_name} PUBLIC -DTARGET_OS_IOS)
         set(PLATFORM_FOLDER ios)
     endif(MACOSX)

 elseif(LINUX)
     target_compile_options(${target_name} PUBLIC -DLINUX)
